...
console.log(new Date('2023-06-03').getFullYear());

//String(문자 데이터) : 따옴표를 사용한다
let myName = "DoYeon";
let email = 'soft8991@gamil.com';
...
let undef; //변수의 초기값이 설정 안되어 있으면 에러
let obj = {pass:1234 , pwd:'abc'} //pass 1234 key value 값으로 들어감
...
//Object (객체 데이터): 여러 데이터를 Key:Value 형태로 저장 { } <=안에 사용
let user ={ 
	//key:value
	name : 'doyean',
	age : 33,
